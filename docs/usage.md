# glormph/nf-core-dda-quant-proteomics: Usage
...
```bash
nextflow run glormph/nf-core-dda-quant-proteomics --mzmls '*.mzML' --tdb swissprot_20181011.fa --mods assets/tmtmods.txt -profile standard,docker
```
...
```bash
nextflow pull glormph/nf-core-dda-quant-proteomics
```

### Reproducibility
It's a good idea to specify a pipeline version when running the pipeline on your data. This ensures that a specific version of the pipeline code and software are used when you run your pipeline. If you keep using the same tag, you'll be running the same version of the pipeline, even if there have been changes to the code since.

First, go to the [glormph/nf-core-dda-quant-proteomics releases page](https://github.com/glormph/nf-core-dda-quant-proteomics/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
...
* `docker`
    ...
    * Pulls software from dockerhub: [`glormph/lehtio-quant-proteomics`](http://hub.docker.com/r/glormph/lehtio-quant-proteomics/)
* `singularity`
