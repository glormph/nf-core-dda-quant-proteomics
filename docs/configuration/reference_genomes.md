# nf-core/dda-quant-proteomics: Reference Genomes Configuration

The nf-core/dda-quant-proteomics pipeline needs a reference genome for alignment and annotation.
